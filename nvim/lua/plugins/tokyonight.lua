require('tokyonight').setup({
    ...
    on_highlights = function(highlights, colors)
        ...
        highlights.StatusLineDither = { fg = colors.dark5, bg = colors.bg_statusline }
        ...
        highlights.TabLineSelTab = { fg = colors.blue, bg = colors.bg_highlight }
        highlights.TabLineSelInactive = { fg = colors.blue, bg = colors.bg_statusline }
        highlights.TabLineDivider = { fg = colors.comment, bg = colors.bg_statusline }
    end,
})
